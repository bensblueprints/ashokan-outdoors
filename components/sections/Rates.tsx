...
const flyFishingInstruction = {
  icon: Fish,
  title: 'Fly Fishing Instruction',
  accent: 'forest',
  borderColor: 'border-forest-500',
  accentBg: 'bg-forest-500',
  glowColor: 'shadow-forest-500/20',
  subtitle: 'Introduction to Fly Fishing and Casting',
  duration: '90 minutes',
  description:
  ...
  prices: [{ label: 'Each Angler', price: '$150' }],
}

const guidedFlyFishing = {
  icon: Compass,
  title: 'Guided Fly Fishing',
  accent: 'creek',
  borderColor: 'border-creek-400',
  accentBg: 'bg-creek-400',
  glowColor: 'shadow-creek-400/20',
  halfDay: [
    { label: 'One Angler', price: '$400' },
    { label: 'Two Anglers', price: '$500' },
    { label: 'Three Anglers', price: '$750', note: '*' },
    { label: 'Four Anglers', price: '$900', note: '*' },
  ],
  fullDay: [
    { label: 'One Angler', price: '$550' },
    { label: 'Two Anglers', price: '$750' },
    { label: 'Three Anglers', price: '$900', note: '*' },
    { label: 'Four Anglers', price: '$1000', note: '*' },
  ],
  footnote: '* May Require Two Guides',
}
...
const guidedHikes = {
  ...
  prices: [
    { label: 'Half Day', sublabel: 'Small Group (4 or less)', price: '$250' },
    { label: 'Full Day', sublabel: 'Small Group (4 or less)', price: '$400' },
  ],
  footnote: '*Custom group rates with additional guides available upon request',
}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <motion.div
            ...
            className={cn(
              ...
              'hover:shadow-xl',
              flyFishingInstruction.glowColor
            )}
          >
            {/* Accent top border */}
            <div className={cn('h-1 w-full', flyFishingInstruction.accentBg)} />
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="mb-4">
                <p className="font-body text-sm text-forest-400 font-medium mb-1">
                  {flyFishingInstruction.subtitle}
                </p>
                <p className="font-body text-xs text-stone-500">
                  {flyFishingInstruction.duration}
                </p>
              </div>

              <div className="mb-6">
                {flyFishingInstruction.prices.map((p) => (
                  <PriceRow key={p.label} label={p.label} price={p.price} />
                ))}
              </div>

              <p className="font-body text-sm text-stone-400 leading-relaxed mb-8">
                {flyFishingInstruction.description}
              </p>
          ...
          <motion.div
            ...
            className={cn(
              ...
              'hover:bg-white/[0.05] hover:border-white/[0.1] transition-all duration-500',
              'hover:shadow-xl',
              guidedFlyFishing.glowColor,
              'lg:scale-[1.03] lg:z-10'
            )}
          >
            {/* Accent top border */}
            <div className={cn('h-1 w-full', guidedFlyFishing.accentBg)} />
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="mb-6">
                ...
                {guidedFlyFishing.halfDay.map((p) => (
                  <PriceRow key={p.label} label={p.label} price={p.price} note={p.note} />
                ))}
              </div>
          ...
          <motion.div
            ...
            className={cn(
              ...
              'hover:bg-white/[0.05] hover:border-white/[0.1] transition-all duration-500',
              'hover:shadow-xl',
              guidedHikes.glowColor
            )}
          >
            {/* Accent top border */}
            <div className={cn('h-1 w-full', guidedHikes.accentBg)} />
