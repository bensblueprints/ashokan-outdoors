...
const headline1 = 'Guided Fly Fishing &'.split(' ')
const headline2 = 'Hiking in the Catskills'.split(' ')
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-24 pb-32">
        ...
        >
          Experience the birthplace of American fly fishing with over three decades of
          local expertise. Our licensed guides provide safe, unforgettable adventures on
          legendary Catskill waters and mountain trails.
        </motion.p>
