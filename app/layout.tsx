...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ashokan.advancedmarketing.co',
  },
  openGraph: {
    title: 'Ashokan Outdoors | Guided Fly Fishing & Hiking in the Catskill Mountains',
    description:
    ...
    images: [
      {
        url: 'https://ashokan.advancedmarketing.co/images/hero-main.jpg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://ashokan.advancedmarketing.co/images/hero-main.jpg'],
  },
}
...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'LocalBusiness',
      '@id': 'https://ashokan.advancedmarketing.co/#business',
      ...
      image: 'https://ashokan.advancedmarketing.co/images/hero-main.jpg',
    },
    {
      '@type': 'WebSite',
      name: 'Ashokan Outdoors',
